    ...
    <div class="form-container-admin">
      <div class="return-container">
        ...
        <div v-if="selectedRental" class="rental-details">
          ...
          <p><strong>Book:</strong> {{ selectedRental.book.title }} ({{ selectedRental.book.author }})</p>
          <p><strong>User:</strong> {{ selectedRental.user.userName }}</p>
...
export default {
  ...
  methods: {
    async loadRental() {
     ...
     /*   const response = await axios.get(`http://localhost:8080/api/rentals/${userId}/${rentalId}`);*/
