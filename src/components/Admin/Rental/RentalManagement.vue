  ...
  <div class="content-container">
    <div class="content-header">
      ...
      <div class="search-bar-container">
        ...
        <router-link to="/admin/rentals/create" class="add-button rental-button">
    ...
    <table>
      ...
      <tr>
        ...
        <th @click="sortRentals('book.title')">Book Title <i class="fas fa-sort"></i></th>
        <th @click="sortRentals('issuedDate')">Issued Date <i class="fas fa-sort"></i></th>
        <th @click="sortRentals('returnedDate')">Returned Date <i class="fas fa-sort"></i></th>
        <th @click="sortRentals('fine')">Fine <i class="fas fa-sort"></i></th>
      ...
      <tr v-for="rental in filteredRentals" :key="rental.id">
        ...
        <td v-if="!rental.editing">{{ rental.book.title }}</td>
        <td v-else>
          <input type="text" v-model="rental.book.title">
        </td>
        ...
        <td>
          <div v-if="!rental.editing">
            ...
            <button @click="deleteRental(rental.id)" class="delete-button">
              <i class="fas fa-trash-alt"></i> Delete
            </button>
            <button @click="openRentalView(rental.id)" class="read-button">
    ...
    <!-- Confirmation modal details may need adjustment -->
    <confirmation-modal
    ...
    >
      <template v-if="rentalToDelete">
        <div>
          ...
          <p>Book Title: {{ rentalToDelete.book.title }}</p>
          <hr>
